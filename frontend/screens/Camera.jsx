...
const CameraComponent = ({ navigation, route }) => {
    ...
    const openImagePickerAsync = async () => {
        ...
        else if (route.params.scanLandlordId) return navigation.navigate("scanlandlordid", { image: data.uri })
        else if (route.params.scanRenterId) return navigation.navigate("scanrenterid", { image: data.uri })
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            >
                ...
                <Icon name="camera" size={40} color="#fff" onPress={clickPicture} testID="click-picture-button"/>
